            ...
            <div className='w-full  max-w-md shadow-lg rounded-xl p-8  bg-white  ' >
                ...
                {step == 1 && <div>
                    ...
                    <div className='flex flex-col mb-4  '>
                        ...
                        <button onClick={() => setStep(2)} className="w-full py-2 px-4 rounded-md font-semibold text-white cursor-pointer bg-[#ff4d2d] hover:bg-[#e64323] transition-colors">
                            Send Otp
                        </button>
                    </div>
                </div>
                ...
                {/* Step 2 */}
                {
                    step == 2 && <div>
                        ...
                        <div className='flex flex-col mb-4  '>
                            ...
                            <button className="w-full py-2 px-4 rounded-md font-semibold text-white cursor-pointer bg-[#ff4d2d] hover:bg-[#e64323] transition-colors">
                                Send Otp
                            </button>
                        </div>
...

                {
                    step == 3 && <div>
                        ...
                        <div className='flex flex-col mb-4  '>
                            <label htmlFor="confirmPassword" className=' font-medium mb-1'>Password</label>
