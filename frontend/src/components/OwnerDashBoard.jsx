...

      {
        myshopData && (<div className='w-full flex flex-col items-center gap-4  px-4  sm:px-6 '>
          ...
          </div>
          {
            ...
            // myshopData.items.map((e, index) => (
            // 
            //<div className="flex h-27.5 w-[80%] max-w-2xl  border rounded-lg border-[#ff4d2d] bg-white shadow-lg overflow-hidden mb-2">

            //   <div className=' min-h-27.5 w-27.5  shrink-0 '>
            //     <img src={e.image} alt="Item Image" className='h-27.5 w-27.5 object-cover rounded-l-lg ' />
            //   </div   >
            //   <div className='flex flex-col justify-start px-2 py-2  flex-1 min-w-0'>

            //     <div className='text-[#ff4d2d]'>{e.name}</div>
            //     <div className="text-sm">
            //       <span className="font-semibold text-gray-800 ">Category:</span> {e.category}
            //     </div>

            //     <div className="text-sm">
            //       <span className="font-semibold text-gray-800">Food Type: </span> {e.foodType}
            //     </div>

            //     <div className='flex justify-between items-center'>
            //       <div className='flex'>₹ {e.price}</div>
