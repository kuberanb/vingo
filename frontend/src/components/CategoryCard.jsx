...
function CategoryCard({ name, imageUrl, onclick }) {
    return (
        <div onClick={onclick} className='w-30 h-30 md:w-45 md:h-45 rounded-2xl border md:border-2  border-[#ff4d2d] shrink-0 overflow-hidden bg-white shadow-xl shadow-gray-200 hover:shadow-lg transition-shadow relative '>
